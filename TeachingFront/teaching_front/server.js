...
const BACKEND_URL = process.env.BACKEND_URL || 'https://linguashineproject-production.up.railway.app';
...
app.use(['/api', '/users', '/feedback', '/files', '/csrf', '/send_query'], createProxyMiddleware({
  target: BACKEND_URL,
  changeOrigin: true,
  secure: true,
  ws: true,
